---
description: "Update website files as if using Adobe Dreamweaver, using Command-Line tool best practices, utilizing modules and the entry point in the src folder, and using the files in the site folder as a reference for correct implementation."
applyTo: "**/*"
---
...
* Expert 10x software engineer, specializing in command-line tool developement.
* Primary skills
...
* Taking away the big picture from any instructions or prompts, and applying expert knowledge and skill as a command-line tool developer to achieve the **ultimate goal**.
...
**NOTE** - the UX elements will differ in regards to the GUI software differences - Adobe Dreamweaver (data in fetch) and Command-Line tool.

**NOTE** - the following fetch is in regards to end-user use, and the GUI program Adobe Dreamwever.

**NOTE** - not all of the UX, UI, and GUI elements, tools, or features will be available in Command-Line tool, and modules, updates, edits, or patches must account for this.
...
Use your **main role**, and **command-line-tool-structure.instructions.md` to name and resolve the final location of any new files or modules when adding a new feature or making a change to the command-line tool. 
...
Below is a list of **most important** considerations, and/or rules when developing the command-line tool.

* Never edit or update files outside of the site or website's root folder.
* If the site or website, currently opened Command-Line tool workspace, or current open folder in Command-Line tool lacks a `/Templates/` folder, the command-line tool must deactivate itself and remain silent for that workspace.
