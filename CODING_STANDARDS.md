# html-dwt-cmd-template Coding Standards

This document defines the coding standards and style conventions for the html-dwt-cmd-template command line tool project. All contributions should follow these guidelines to maintain consistency and code quality.

## 1. Purpose and Scope

**Purpose:** To ensure consistent code quality, readability, and maintainability across the TypeScript codebase for the Dreamweaver-style template command-line tool.
...
```typescript
// logger
// Provides structured logging utilities for the command-line tool.
```
...
## 8. command line tool Patterns

### 8.1 Command Registration

- Register all commands in the `activate` function
- Add all disposables to `context.subscriptions`
- Use descriptive command IDs with command-line tool prefix
